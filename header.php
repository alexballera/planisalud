...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		<hgroup>
			<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?>Estoy aqui</a></h1>
...
<IMG SRC="wp-includes/images/planisalud/chat-superior2.png" style="height: 40px; margin-left: 73px;    width: 40px;"> <div id="chateaconnosotros" style="left: 106px; color: #2cb4aa; position: relative; font-weight: bold; cursor: pointer; font-size: 18px; margin-left: 16px; top: -23px;">¡Chatea con nosotros!<img style=" left: 3px; top: 11px;" class ="cero"  height="58px" width="193px" alt="" />
		</div>
</div>
<div>
</div>
<div align="right" id="input-header"  >
<aside class="widget widget_search" id="search-2"><form action="http://www.planisalud.com" class="searchform-2" id="searchform-2" method="get" role="search" autocomplete="on">
				<div>
